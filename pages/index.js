...
// Chapter 2 Module Content - Approach Focused (City metaphor stripped for tutor)
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-slate-800 rounded-xl p-6 mb-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold">Chapter 2: Understanding the Territory</h3>
            ...
            <div className="text-center text-slate-500 text-sm">
              <p>SYTYCSN Adaptive Learning Platform — POC v0.4</p>
